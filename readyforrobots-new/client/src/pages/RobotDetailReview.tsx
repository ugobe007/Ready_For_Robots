  ...
  return (
    <main className="min-h-screen bg-[#081126] text-[#edf4f3]">
      <div className="mx-auto max-w-3xl px-5 py-10">
        ...
        <p className="mt-8 text-[10px] font-semibold uppercase tracking-[0.36em] text-[#7adfc8]">Confirmed Profile</p>
        <h1 className="mt-3 text-3xl font-semibold text-slate-50">Robot #{params.robotId}</h1>
        <p className="mt-3 text-sm text-slate-300">
          Immutable profile version {profile || "saved"}. Facility opportunity search lands in Slice 2–5.
        </p>
        <Link
