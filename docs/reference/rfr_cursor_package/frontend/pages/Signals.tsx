...
import { AlertTriangle, TrendingUp, DollarSign, Newspaper, Building2, Briefcase, Activity, Globe, Zap, Filter, Search, ChevronRight, Handshake, Users, Network } from "lucide-react";
...
const SIGNAL_TYPES = [
  ...
  {
    id: "partner-seeking",
    name: "SI Seeking Vendor",
    icon: Handshake,
    color: "#03DAC5",
    category: "Partnership",
    description: "System integrators and VARs actively seeking new robot vendors to add to their portfolio — the highest-intent partnership signal.",
    sources: ["SI directories", "Trade show exhibitor lists", "LinkedIn RFPs", "Industry forums"],
    industries: ["All industries"],
    example: "\"Seeking AMR vendor partnerships for 3 new warehouse projects\" — RFP posted, Meridian Systems Integration",
    frequency: "Weekly",
    avgScore: 91,
  },
  {
    ...
    color: "#60a5fa",
    category: "Partnership",
    description: "Distributors and VARs expanding into mobile robotics or automation — hiring product managers, signing new OEM agreements, or attending robot-focused trade shows.",
    sources: ["LinkedIn job posts", "Trade show registrations", "Press releases", "OEM announcements"],
    industries: ["All industries"],
    example: "Distributor hiring AMR product manager + signed 2 new OEM agreements — Apex Automation Distributors",
    frequency: "Weekly",
    avgScore: 86,
  },
  {
    id: "partner-contract",
    name: "SI Contract Win",
    icon: Users,
    color: "#a78bfa",
    category: "Partnership",
    description: "System integrators winning new automation contracts create immediate demand for robot hardware — the perfect moment to propose a partnership.",
    sources: ["Press releases", "LinkedIn announcements", "Government contract databases", "Trade publications"],
    industries: ["Logistics", "Manufacturing", "Healthcare", "Food Processing"],
    example: "Won 3 new hospitality automation contracts — seeking additional robot SKUs to bundle — Pacific Rim Robotics",
    frequency: "Weekly",
    avgScore: 88,
  },
];

const CATEGORIES = ["All", "Operational", "Growth", "Financial", "Intent", "External", "Partnership"];
const INDUSTRIES = ["All", "Logistics", "Hospitality", "Healthcare", "Manufacturing", "Food Processing", "Retail"];

const recentPartnerSignals = [
  { company: "Meridian Systems Integration", type: "SI Seeking Vendor", score: 91, time: "1h ago", color: "#03DAC5" },
  { company: "Apex Automation Distributors", type: "Portfolio Expansion", score: 86, time: "3h ago", color: "#60a5fa" },
  { company: "Pacific Rim Robotics", type: "SI Contract Win", score: 88, time: "5h ago", color: "#a78bfa" },
  { company: "Northeast Automation Group", type: "Portfolio Expansion", score: 83, time: "8h ago", color: "#60a5fa" },
  { company: "Velocity Industrial Partners", type: "SI Seeking Vendor", score: 89, time: "12h ago", color: "#03DAC5" },
];
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {CATEGORIES.map((cat) => (
                    <button
                      ...
                      style={
                        category === cat
                      ? { background: "#03DAC5", borderColor: "#03DAC5", color: "#000" }
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {INDUSTRIES.map((ind) => (
                    <button
                      ...
                      style={
                        industry === ind
                      ? { background: "rgba(3,218,197,0.12)", borderColor: "#03DAC5", color: "#03DAC5" }
                        ...
                        <div className="px-5 pb-5 border-t border-white/6 pt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                          ...
                          <div className="sm:col-span-2 flex items-center gap-3">
                            ...
                            <button
                              ...
                              className="ml-auto text-xs font-semibold px-3 py-1.5 rounded-lg text-black transition-all"
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="ml-auto h-1.5 w-1.5 rounded-full animate-pulse" style={{ background: "#03DAC5" }} />
                </div>
                <div className="space-y-3">
              ...
              {/* Partnership live feed */}
              <div
                className="rounded-2xl border border-white/8 p-5"
                style={{ background: "rgba(3,218,197,0.03)", borderColor: "rgba(3,218,197,0.15)" }}
              >
                <div className="flex items-center gap-2 mb-4">
                  <Handshake className="h-3.5 w-3.5" style={{ color: "#03DAC5" }} />
                  <span className="text-xs font-bold uppercase tracking-widest" style={{ color: "#03DAC5" }}>Partner signals</span>
                  <span className="ml-auto h-1.5 w-1.5 rounded-full animate-pulse" style={{ background: "#03DAC5" }} />
                </div>
                <div className="space-y-3">
                  {recentPartnerSignals.map((sig, i) => (
                    <div key={i} className="flex items-start gap-3">
                      <span className="h-1.5 w-1.5 rounded-full shrink-0 mt-1.5" style={{ background: sig.color }} />
                      <div className="flex-1">
                        <p className="text-xs font-semibold text-white/70">{sig.company}</p>
