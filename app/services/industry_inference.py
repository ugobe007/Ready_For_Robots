...
KNOWN_COMPANY_INDUSTRY: Dict[str, str] = {
    ...
    # ── Unknown-industry rescue (2026-06-23 ontology mission) ────────────────
    ...
    "red hat": "Datacenters",
    "tenaris": "Automotive & Manufacturing",
    "telefónica": "Telecom",
    "telefonica": "Telecom",
    "alphabet": "Datacenters",
    "roche diagnostics": "Medical Technology",
    "uline": "Logistics",
    "kempinski": "Hospitality",
    "avelo": "Airports & Aviation",
    "addverb": "Logistics",
    "curiox biosystems": "Medical Technology",
    "eversana": "Pharmaceuticals & Life Sciences",
    "cambrex": "Pharmaceuticals & Life Sciences",
    "hindustan copper": "Mining & Extraction",
    "neuromeka": "Automotive & Manufacturing",
    "mecademic": "Automotive & Manufacturing",
    "verallia": "Manufacturing",
    "newcold": "Logistics",
    "feralpi stahl": "Automotive & Manufacturing",
    "standard meat co": "Food Processing & Manufacturing",
    "sciex": "Medical Technology",
    "distalmotion": "Medical Technology",
    "newman regional health": "Healthcare",
    "baptist health": "Healthcare",
    "uvm health": "Healthcare",
    "spokane public school": "Education",
    "fort worth fire department": "Government & Public Sector",
    "herpak-ulma": "Food Processing & Manufacturing",
    "wolf packing": "Food Processing & Manufacturing",
    "palfinger": "Construction & Building",
    "allient": "Automotive & Manufacturing",
    "lucid group": "Automotive & Manufacturing",
    "lucid motors": "Automotive & Manufacturing",
    "beaches turks": "Hospitality",
    "wingate": "Hospitality",
    "society seafood house": "Food Service",
    "graymatter": "Datacenters",
    "proteus": "Medical Technology",
    "mitwell": "Healthcare",
    "yango group": "Logistics",
    "datasea": "Datacenters",
    "primech holdings": "Real Estate & Facilities",
    "i-berhad": "Hospitality",
    "chef robotics": "Automotive & Manufacturing",
    "blueflite": "Logistics",
    "sharebot": "Automotive & Manufacturing",
    "largo": "Medical Technology",
    "sse steel fabrication": "Construction & Building",
    "man and mvg": "Automotive & Manufacturing",
    "kalmar": "Ports & Maritime",
    "sunrobi": "Logistics",
    "vexilar": "Manufacturing",
    "orchestra pe": "Financial Services",
