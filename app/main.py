...
from app.api.jobs_watch import router as jobs_watch_router
...
app.include_router(jobs_watch_router, prefix="/api/crm", tags=["crm"])
app.include_router(jobs_crm_router, prefix="/api/jobs-crm", tags=["jobs-crm"])
