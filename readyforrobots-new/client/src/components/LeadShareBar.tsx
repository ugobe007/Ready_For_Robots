...
const VARIANT_STYLES = {
  light: {
    ...
    chip: "border-gray-200 bg-gray-50 text-gray-700 hover:bg-gray-100 hover:text-gray-900",
    chipLinkedIn: "border-gray-200 bg-gray-50 text-gray-700 hover:bg-sky-50 hover:text-sky-800",
    chipCopy: "border-gray-200 bg-gray-50 text-gray-700 hover:text-emerald-700",
  },
  dark: {
    label: "text-white/30",
...
export default function LeadShareBar({ lead, compact = false, className = "", variant = "light" }: Props) {
