...
GitHub **Deploy frontend to Vercel** needs `VERCEL_TOKEN`. Missing token used to skip-green; `vercel pull` fails on project-scoped tokens. See `docs/vercel_production_secrets.md`.
