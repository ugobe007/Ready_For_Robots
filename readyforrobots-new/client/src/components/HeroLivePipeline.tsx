...
export default function HeroLivePipeline() {
  ...
  const rows = useMemo(
    () => (apiLeads && apiLeads.length ? apiLeads : STATIC_FALLBACK),
    [apiLeads]
  );
    ...
    <div className="relative w-full">
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 24px 64px -12px rgba(124,58,237,0.15), 0 0 0 1px rgba(255,255,255,0.06) inset",
        }}
      >
        <div
        ...
        >
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="rfr-scout-wordmark text-[9px] text-violet-200/80 truncate">
                SIGNAL spotlight
              </p>
            </div>
          </div>
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, rgba(124,58,237,0.08), rgba(52,211,153,0.06))",
          }}
        >
          <div
            className="h-8 w-8 rounded-lg border border-white/10 bg-white/5 flex items-center justify-center shrink-0 text-sm"
            aria-hidden
          >
            📈
          </div>
          <div className="min-w-0">
            ...
            <p className="text-[11px] text-white/40 truncate">
              &quot;Opening 2 new DCs next Q&quot; — logistics
            </p>
          </div>
        </div>
        ...
        >
          <Link
            href="/pipeline"
            className="text-xs font-semibold flex items-center gap-1 text-violet-200 hover:text-white transition-colors"
          >
            View full pipeline
