...
AI_STACK_BY_SLUG: Dict[str, Dict[str, Any]] = {
    ...
    "neura-4ne1": {
        "primary_model": "Neura cognitive robotics stack",
        "model_family": "hybrid",
        "stack_layers": ["cognitive layer", "motion"],
        "compute": "On-robot",
        "third_party": ["NVIDIA GR00T ecosystem"],
        "unique_claim": "German cognitive robotics; 4NE1 humanoid for industrial collaboration.",
    },
    "dexmate-vega": {
