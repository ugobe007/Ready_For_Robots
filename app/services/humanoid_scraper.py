...
SEED_ROBOTS: list[dict] = [
    ...
    },
    {
        ...
        "specs": {
            ...
            "hot_swap_battery": True,
            "total_dof": 44,
            "dof_note": "Cognitive humanoid with AURA perception; reservations open (neura-robotics.com)",
        },
    },
    {
        ...
        "specs": {
            ...
            "total_dof": 42,
            "peak_torque_nm": 350,
            "dof_note": "Arm payload 7.5 kg; static body load 40 kg; 11-DOF hands (6 active); 100 TOPS compute (magiclab.top)",
        },
    },
]
