...
_PROVIDER_META: dict[str, dict[str, Any]] = {
    PROVIDER_HUBSPOT: {
        ...
        "description": "Push SCOUT-qualified leads into HubSpot contacts and companies.",
    ...
    PROVIDER_GITHUB: {
        ...
        "description": "Let SCOUT read repos and automation context from your GitHub workspace.",
