            ...
            <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr]">
              <div className="border-b border-slate-600 p-6 lg:border-b-0 lg:border-r">
                ...
                <p className="mt-4 max-w-xl text-[13px] leading-relaxed text-slate-400">
                  Companies have work. Robots need jobs. Paste a product URL, inspect the cards, check the jobs to take forward. Next is Place — quote the rental, apply. {CRM_UNLOCKED_JOBS} jobs on free. Not a buyer pipeline.
                </p>
