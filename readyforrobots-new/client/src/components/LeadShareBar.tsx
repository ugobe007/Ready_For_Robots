...
export function buildLeadSharePost(lead: LeadShareInput): {
  tweetText: string;
  shareUrl: string;
  fullSummary: string;
} {
...
const VARIANT_STYLES = {
  light: {
    ...
    chipLinkedIn:
      "border-gray-200 bg-white text-gray-700 hover:bg-sky-50 hover:text-sky-800",
    chipMail:
      "border-gray-200 bg-white text-gray-700 hover:bg-emerald-50 hover:text-emerald-800",
    chipWhatsApp:
      "border-gray-200 bg-white text-gray-700 hover:bg-green-50 hover:text-green-800",
  ...
  dark: {
    ...
    chipLinkedIn:
      "border-white/10 bg-white/5 text-white/50 hover:bg-[#0a66c2]/20 hover:text-white",
    chipMail:
      "border-white/10 bg-white/5 text-white/50 hover:bg-emerald-500/20 hover:text-white",
    chipWhatsApp:
      "border-white/10 bg-white/5 text-white/50 hover:bg-green-500/20 hover:text-white",
...
export default function LeadShareBar({
  lead,
  compact = false,
  panel = false,
  className = "",
    ...
    return (
      ...
      >
        <a
          ...
          title="Share on X"
          className={`rounded p-1 transition-colors ${v.icon}`}
        >
        ...
        <a
          ...
          className={`rounded p-1 transition-colors ${v.iconLinkedIn}`}
        >
        ...
        <a
          ...
          className={`rounded p-1 transition-colors ${v.iconWhatsApp}`}
        >
        ...
        <button
          ...
          className={`rounded p-1 font-mono text-[10px] transition-colors ${v.copy}`}
        >
          {copied ? "✓" : "⧉"}
        </button>
      </div>
  ...
  if (panel) {
    return (
      <div
        className={`pipeline-detail-share ${className}`}
        onClick={e => e.stopPropagation()}
      >
        <div className="mb-2 flex items-start gap-2">
          ...
          <div>
            ...
            <p className="mt-0.5 text-[11px] leading-relaxed text-gray-600">
              Share this job with colleagues — post to social, email your team,
              or copy a ready-made blurb.
            </p>
          </div>
        </div>
        <div className="flex flex-wrap gap-1.5">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className={`inline-flex items-center gap-1.5 rounded-md border px-2.5 py-1.5 text-[11px] font-semibold transition-colors ${v.chip}`}
          >
            <XIcon className="h-3.5 w-3.5" />
            Post on X
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className={`inline-flex items-center gap-1.5 rounded-md border px-2.5 py-1.5 text-[11px] font-semibold transition-colors ${v.chipLinkedIn}`}
          >
            <LinkedInIcon className="h-3.5 w-3.5" />
            LinkedIn
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className={`inline-flex items-center gap-1.5 rounded-md border px-2.5 py-1.5 text-[11px] font-semibold transition-colors ${v.chipWhatsApp}`}
          >
            <WhatsAppIcon className="h-3.5 w-3.5" />
            WhatsApp
          </a>
          <button
            type="button"
            onClick={copyPost}
            className={`inline-flex items-center gap-1.5 rounded-md border px-2.5 py-1.5 text-[11px] font-semibold transition-colors ${v.chipCopy}`}
          >
          ...
          {canNativeShare ? (
            <button
              type="button"
              onClick={nativeShare}
              className={`inline-flex items-center gap-1.5 rounded-md border px-2.5 py-1.5 text-[11px] font-semibold transition-colors ${v.chipNative}`}
            >
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center gap-2">
        <span
          className={`text-[10px] font-bold uppercase tracking-widest ${v.label}`}
        >
          Share
        </span>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className={`inline-flex items-center gap-1.5 rounded border px-2 py-1 text-[10px] font-medium transition-colors ${v.chip}`}
        >
          X
        </a>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className={`inline-flex items-center gap-1.5 rounded border px-2 py-1 text-[10px] font-medium transition-colors ${v.chipLinkedIn}`}
        >
          LinkedIn
        </a>
        <a
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className={`inline-flex items-center gap-1.5 rounded border px-2 py-1 text-[10px] font-medium transition-colors ${v.chipWhatsApp}`}
        >
          WhatsApp
        </a>
        <button
          type="button"
          onClick={copyPost}
          className={`inline-flex items-center gap-1 rounded border px-2 py-1 text-[10px] font-medium transition-colors ${v.chipCopy}`}
        >
