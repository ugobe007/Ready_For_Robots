...
PIPELINE_LIMIT_ANONYMOUS = 24
PIPELINE_ANON_HOT_SLOTS = 12
PIPELINE_ANON_WARM_SLOTS = 8
PIPELINE_ANON_MONITOR_SLOTS = 4

PIPELINE_LIMIT_FREE = 30
PIPELINE_FREE_HOT_SLOTS = 15
PIPELINE_FREE_WARM_SLOTS = 10
PIPELINE_FREE_MONITOR_SLOTS = 5
