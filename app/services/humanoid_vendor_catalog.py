...
HUMANOID_CATALOG: List[Dict[str, Any]] = [
    ...
    {"name": "UBTECH Walker S", "vendor": "UBTECH Robotics", "model_slug": "ubtech-walker-s", "product_url": "https://www.ubtrobot.com/en/", "vendor_url": "https://www.ubtrobot.com", "vendor_name_cn": "优必选科技", "robot_name_cn": "Walker S", "vendor_aliases": "UBTECH|优必选|优必选科技|UBTECH Robotics|UBTech", "robot_aliases": "Walker S|Walker S1|Walker S2|UBTECH Walker S", "authoritative": ["vendor_name_cn"], "status": "pilot", "country": "China", "specs": {"height_cm": 170, "weight_kg": 70, "total_dof": 41, "payload_kg": 15.0, "dof_note": "Weight 65–76 kg across configurations; industrial humanoid deployed in factories (RBTX)"}},
