      ...
      <div className="container">
        <div className="text-center mb-8">
          <p className="section-eyebrow mb-3">
            What ReadyForRobots SIGNAL Does
          </p>
            ...
            return (
              ...
              >
                <div className="mb-4 flex items-start justify-between">
                  <div
                    className={`h-11 w-11 rounded-lg flex items-center justify-center ${f.iconTone}`}
                  >
                    <Icon size={22} />
                  </div>
                  <div className="text-right">
                    ...
                    />
                    <div className="text-gray-500 text-xs font-mono-data">
                      {f.statLabel}
                    </div>
                  </div>
                </div>
                <h3 className="mb-1.5 font-display text-xl font-bold text-gray-900">
                  {f.title}
                </h3>
...
export function MarketingHowItWorks() {
  const steps = [
    {
      ...
      mockup: {
        ...
        lines: [
          "3 DC expansions · Midwest US",
          "Labor shortage filing · match",
        ],
        accent: "text-sky-700",
        bar: 72,
      },
  ...
  return (
    <section
      id="how-it-works"
      className="overflow-hidden bg-slate-100/70 py-14 lg:py-16"
    >
      <div className="container">
                ...
                <div key={step.num} className="relative flex flex-col">
                  <div className="mb-4 flex flex-col items-center text-center">
                    <div className="relative z-10 mb-4">
                      ...
                      <span
                        className={`absolute -top-2 -right-2 flex h-7 w-7 items-center justify-center rounded-full bg-white border font-mono-data text-[10px] font-bold shadow-sm ${
                          i === 0
                  ...
                  <div className="mt-auto rounded-xl border border-gray-200 bg-white p-3.5 shadow-sm">
                    <div className="mb-2.5 flex items-center justify-between gap-2 border-b border-gray-100 pb-2">
                      ...
                      <FileText
                        size={14}
                        className={`shrink-0 ${i === 0 ? "text-sky-500" : i === 1 ? "text-amber-500" : "text-slate-500"}`}
                      />
                    </div>
                    <p
                      className={`mb-1.5 text-sm font-semibold ${step.mockup.accent}`}
                    >
                      {step.mockup.title}
                    </p>
                    <div className="space-y-1">
                      {step.mockup.lines.map(line => (
                        <p
                          key={line}
                          className="text-xs text-gray-600 leading-relaxed font-mono-data"
                        >
                          {line}
                        </p>
                      ))}
                    ...
                    <div className="mt-2.5 flex items-center gap-2">
                      <div className="signal-strength-track flex-1 max-w-none">
                        <div
                          ...
                          style={{ width: `${step.mockup.bar}%` }}
                        />
                      </div>
                      {i < steps.length - 1 && (
                        <span
                          className="hidden lg:inline text-gray-300"
                          aria-hidden
                        >
                          →
                        </span>
      ...
      <div className="container relative">
        <div className="mb-10 max-w-2xl">
          ...
          <p className="mt-3 text-sm leading-relaxed text-slate-600">
            Same sales team — different pipeline when buyer intent leads the
            motion.
          </p>
        </div>
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div className="before-after-panel-before-body">
              ...
              <ul className="space-y-3">
                {before.map(item => (
                  <li
                    key={item}
                    className="before-after-list-item before-after-list-item-before"
                  >
                    <XCircle
                      size={15}
          ...
          <div className="before-after-panel-after">
            <div className="before-after-panel-after-header">
              <span className="before-after-badge-after">
            ...
            <div className="before-after-panel-after-body">
              ...
              <ul className="space-y-3">
                {after.map(item => (
                  <li
                    key={item}
                    className="before-after-list-item before-after-list-item-after"
                  >
                    <CheckCircle
                      size={15}
        ...
        <div className="mb-10 max-w-2xl">
          ...
          <h2 className="section-headline font-bold text-white">
            ...
            <span className="text-sky-300">
              SIGNAL knows who&apos;s buying robots.
            </span>
          </h2>
          <p className="mt-3 text-sm leading-relaxed text-slate-400">
            Horizontal &ldquo;AI&rdquo; search and data tools hand you a list.
            ReadyForRobots hands you a moving pipeline built for robot companies
            — verified buyer intent, the right SKU, and deals advancing in CRM.
          </p>
        </div>
          ...
          <div className="rounded-2xl border border-sky-300/35 bg-sky-400/[0.08] p-5 shadow-[0_0_40px_-12px_rgba(56,189,248,0.45)]">
            ...
            <ul className="space-y-3">
              {rows.map(row => (
                <li
                  key={row.rfr}
                  className="flex items-start gap-2.5 text-sm font-medium leading-relaxed text-slate-100"
                >
                  <CheckCircle
                    size={15}
      ...
      <div className="container">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:gap-5">
          {cases.map(c => (
            <div
              key={c.industry}
              className="rounded-2xl border border-gray-200 bg-slate-50/70 p-5 shadow-sm"
            >
              <div className="mb-4 flex items-center justify-between">
                ...
                <span
                  className={`text-xs font-mono-data font-bold px-3 py-1 rounded-full ${c.outcomeColor}`}
                >
                  {c.outcome}
                </span>
              </div>
            ...
            >
              <div className="mb-5 pb-4 border-b border-gray-100">
                ...
                <div className="flex items-end justify-between gap-3">
                  <div>
                    <span className="score-number text-2xl leading-none">
                      {t.signalScore}
                    </span>
                    <p className="text-[10px] font-mono-data text-gray-500 mt-1 uppercase tracking-wide">
                      Signal strength
                    </p>
                  </div>
...
export function MarketingBenchmark({
  benchReport,
}: {
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 text-base leading-relaxed mb-6">
              The HEIR benchmark tracks humanoid robots across data pipeline,
              cognition, mobility, and deployment readiness. Updated monthly.
            </p>
            <div className="mb-6 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3">
              ...
              <p className="mt-1 text-sm font-semibold text-gray-900">
                HEIR July 2026 Update: 20 new humanoids + US China-origin
            ...
            <Link
              href="/robots"
              className="inline-flex items-center gap-2 text-sky-700 font-semibold text-sm hover:text-sky-800"
            >
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div>
              {robots.map((robot, i) => (
                ...
                >
                  <span className="font-mono-data text-gray-900 text-sm font-bold w-5 text-right flex-shrink-0">
                    {i + 1}
                  </span>
                  <div className="flex-1 min-w-0">
                    <div className="font-display font-semibold text-gray-900 text-sm truncate">
                      {robot.name}
                    </div>
...
export function MarketingReportSection({
  onOpenReport,
}: {
  onOpenReport: () => void;
}) {
        ...
        <div className="rounded-3xl bg-gradient-to-br from-slate-900 via-slate-800 to-sky-950 p-10 lg:p-14 flex flex-col lg:flex-row items-center gap-10">
          <div className="flex-1">
            ...
            <p className="text-slate-400 text-base leading-relaxed mb-8 max-w-lg">
              Our enterprise intelligence report analyzes labor-intensive
              industries, robotics buying signals, and ROI benchmarks so sales
              teams know where automation demand is forming now.
            </p>
            <div className="grid grid-cols-3 gap-6 mb-8">
              {[
                ...
                <div key={stat.label}>
                  <div className="font-mono-data font-bold text-3xl text-sky-300 mb-1">
                    {stat.value}
                  </div>
          ...
          <div className="flex-shrink-0 w-56 h-72 bg-slate-700/50 rounded-2xl border border-white/10 flex flex-col items-center justify-center p-6 text-center">
            ...
            <div className="font-display font-bold text-white text-xl leading-tight mb-2">
              The Automation Imperative
            </div>
            <div className="text-slate-400 text-xs leading-relaxed mb-4">
              Labor shortages, capital availability, and leadership commitment
              are creating a 2026 inflection point for robotics adoption.
            </div>
            <div className="text-slate-500 text-xs font-mono-data">
              June 2026 · ReadyForRobots
            </div>
          </div>
        </div>
      </div>
...
const HOME_PRICING_TIERS = [
  {
    ...
    features: [
      "URL scan & buyer matching",
      "15 live pipeline leads",
      "Save up to 5 leads",
    ],
    highlight: false,
  },
      ...
      <div className="container relative">
        <div className="text-center mb-12 max-w-2xl mx-auto">
          ...
          <p className="text-sm text-slate-400">
            Start free — scan URLs, browse the pipeline, upgrade when you need
            research and CRM sync.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="mb-2 flex items-baseline gap-1">
                  <span
                    className={`font-mono-data text-3xl font-bold ${tier.highlight ? "text-emerald-300" : "text-slate-100"}`}
                  >
                    {tier.price}
                  </span>
                  {tier.period && (
                ...
                <ul className="space-y-2 mb-6 flex-1">
                  {tier.features.map(feature => (
                    ...
                    >
                      <CheckCircle2
                        size={14}
                        className={`shrink-0 mt-0.5 ${tier.highlight ? "text-emerald-400" : "text-sky-400"}`}
                      />
                      {feature}
                    </li>
                  ))}
                    ...
                    onClick={() => {
                      if ("checkoutTier" in tier && tier.checkoutTier) {
                        window.location.assign(
                          signupHrefForCheckout(tier.checkoutTier)
                        );
                        return;
                      }
...
export function MarketingFinalCTA({ hotCount, totalCount }: StatsProps) {
  ...
  return (
    <section className="cta-section-bg relative overflow-hidden py-24">
      {/* Glow orbs */}
      <div
        className="pointer-events-none absolute -top-20 left-[10%] h-64 w-64 rounded-full bg-emerald-500/[0.12] blur-[70px]"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute bottom-[-4rem] right-[8%] h-72 w-72 rounded-full bg-sky-500/[0.09] blur-[80px]"
        aria-hidden
      />
      <div className="container relative text-center">
        ...
        <h2
          className="font-display text-4xl lg:text-5xl font-bold text-white tracking-tight mb-6"
        ...
        <div className="flex items-center justify-center gap-8 mb-8 flex-wrap">
          {[
            ...
            <div key={s.label} className="text-center">
              ...
              />
              <div className="text-slate-500 text-xs font-mono-data mt-0.5">
                {s.label}
              </div>
            </div>
          ))}
        ...
        <p className="text-slate-600 text-xs mt-5 font-mono-data">
          No signup to scan · Free pipeline preview · Upgrade when you save
          leads
        </p>
      </div>
    </section>
      ...
      <div className="container relative py-16 lg:py-20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-slate-400 text-base leading-relaxed mb-8 max-w-xl mx-auto">
            Buying signals, deployment moves, and strategic hires — curated
            daily for robotics sales teams. Free.
          </p>
          <form
            onSubmit={onSubmit}
          ...
          {newsletterStatus === "success" && (
            <p className="text-sky-300 text-sm mt-4 font-medium">
