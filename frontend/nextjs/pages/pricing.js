      ...
      <main className="scout-page px-4 py-12">
        <div className="max-w-6xl mx-auto">
          ...
          <form onSubmit={submit} className="scout-card p-6 grid md:grid-cols-2 gap-4">
            ...
            <input className="scout-input" required type="email" placeholder="Email" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} />
            <input className="scout-input" placeholder="Name" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} />
            <input className="scout-input" placeholder="Company" value={form.company} onChange={(e) => setForm({ ...form, company: e.target.value })} />
            <input className="scout-input" placeholder="Robotics use case" value={form.useCase} onChange={(e) => setForm({ ...form, useCase: e.target.value })} />
