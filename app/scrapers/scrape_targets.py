...
JOB_BOARD_TARGETS: List[ScrapeTarget] = [
    ...
    ScrapeTarget(
        url="https://www.simplyhired.com/search?q=line+cook+hotel+casino+airport+kitchen&l=United+States",
        label="SimplyHired - Hotel / casino / airport kitchen cooks",
        scraper="job_board", cadence="daily",
        industries=["Food Service"],
        signal_types=["robot_job"],
    ),
    ScrapeTarget(
        url="https://www.simplyhired.com/search?q=banquet+server+busser+casino+hotel+airport+mall&l=United+States",
        label="SimplyHired - Banquet / busser hotel casino airport mall",
        scraper="job_board", cadence="daily",
        industries=["Food Service"],
        signal_types=["robot_job"],
    ),
    ScrapeTarget(
        url="https://www.simplyhired.com/search?q=janitor+custodian+hotel+casino+airport+office+mall+data+center&l=United+States",
        label="SimplyHired - Janitor / custodian hotels through data centers",
        scraper="job_board", cadence="daily",
        industries=["Hospitality"],
        signal_types=["robot_job"],
    ),
