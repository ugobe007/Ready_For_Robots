    ...
    <div className="min-h-screen bg-neutral-950 text-neutral-100">
      ...
      <div className="flex items-center justify-between p-4 sm:px-6 border-b border-neutral-800">
        <Link href="/" className="flex items-center gap-2">
          <span className="text-base font-bold text-white tracking-wide">READY</span>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 space-y-16">
        ...
        {/* 1. CTA - Value First */}
        <div className="border border-emerald-700 rounded-lg px-6 py-8 text-center">
        ...
        {/* 2. Signal Intelligence Explanation */}
        ...
        {/* 3. Live Signal Examples - 3-5 HOT Leads (Clickable) */}
        <div className="space-y-6">
        ...
        <div className="space-y-6">
          ...
          <div className="border border-neutral-800 rounded-lg p-5 bg-neutral-900/30">
            <h3 className="text-sm font-semibold text-white mb-3">Sample Outreach Template</h3>
            <div className="space-y-2 text-xs text-neutral-400">
              <p><strong className="text-neutral-300">Subject:</strong> Re: [Company's] recent [Signal Type]</p>
              <p><strong className="text-neutral-300">Body:</strong></p>
              <p className="pl-4 border-l-2 border-neutral-700 py-2">
                "Hi [Name],<br/><br/>
                I noticed [Company] recently [specific signal - e.g., 'announced your Denver warehouse expansion']. Based on similar deployments in [Industry], companies at this stage typically see 30-40% labor cost reduction with [Robot Type].<br/><br/>
                Would a 15-minute conversation about automation ROI make sense for your timeline?"
              </p>
            </div>
          </div>
        </div>
