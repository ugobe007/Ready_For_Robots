...
const tiers = [
  {
    ...
    price: "$19.99",
    period: "/month",
    tagline: "Essential lead activation for individual sellers & robot OEMs",
    accent: "emerald" as const,
    icon: Zap,
    cta: "Start Basic Plan",
    ctaAction: "signup",
    features: [
      "25 Activated Buyer Leads / Month",
      "ReadyForRobots Cal Managed Outreach & Meeting Agent",
      "Paste any robot URL or SKU to match qualified jobs",
      "Vault Contact Protection (Zero buyer spam)",
      "Pipeline Kanban board & native CRM desk",
      "Direct robot-to-work job matching",
    ],
    limitations: [
      "25 activated leads/mo cap (Upgrade to Pro for unlimited)",
      "HubSpot & Hunter.io manual connect",
    ],
    highlight: false,
  },
  {
    ...
    price: "$49.99",
    period: "/month",
    tagline: "Unlimited pipeline + SIGNAL research for active sales teams",
    ...
    features: [
      "Everything in Basic",
      "Unlimited Activated Buyer Leads",
      "Priority Cal Managed Outreach & Meeting Agent",
      "SIGNAL research updates on WARM and HOT leads",
      "HubSpot & Hunter.io auto-sync (push score, trigger, brief)",
