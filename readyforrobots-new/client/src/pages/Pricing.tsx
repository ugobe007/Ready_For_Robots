...
const tiers = [
  {
    ...
    features: [
      ...
      "Save and preview matched jobs in native CRM",
      "Direct robot-to-work job matching",
    ],
    limitations: [
      "No lead activation or outreach (Requires Paid Account)",
      "HubSpot connect only — auto-sync on Pro",
      "Raw buyer emails & phones protected in Vault",
    ],
    highlight: false,
  },
  {
    ...
    price: "$49",
    period: "/month",
    tagline: "Full pipeline + Cal Managed Outreach Agent for active sellers",
    ...
    features: [
      "Everything in Free",
      "ReadyForRobots Cal Managed Outreach & Meeting Scheduling",
      "Vault Contact Protection (Zero buyer spam — Cal handles proxy)",
      "Unlimited activated leads & CRM auto-sync",
